  ...
  const sortedAndFilteredProfiles = useMemo(() => {
    return daycarePlayhomes
      .filter(profile => {
        ...
        // Price filter
        if (onlyFreeCoop && profile.hourlyRate > 0) return false;
        if (profile.hourlyRate > maxHourlyPrice) return false;
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-5 sm:p-6 space-y-5">
            ...
            <div className="pt-2 border-t border-slate-100 flex flex-wrap items-center justify-between gap-3 text-xs">
              ...
              <div className="text-[11px] font-extrabold text-slate-600 bg-slate-100 px-3 py-1 rounded-full">
                Found <strong>{sortedAndFilteredProfiles.length}</strong> matching profiles (Closest first)
              </div>
            </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative h-44 w-full bg-slate-100 overflow-hidden">
                        ...
                        {/* Top Right Hourly Rate (CRITICAL USER REQUEST) */}
                        <div className="absolute top-3 right-3">
                          <div className="bg-white text-slate-950 px-3 py-1 rounded-2xl shadow-md text-right border border-slate-100">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div className="min-w-0">
                              ...
                              <span className="text-[10px] text-slate-200 block truncate">
                                {profile.providerType} • {profile.experienceYears}y exp
                              </span>
                            </div>
                          </div>
                      ...
                      <div className="p-4 space-y-3 flex-1 flex flex-col justify-between">
                        ...
                        <div className="pt-2 border-t border-slate-100">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            >
                              <span>Book Sitter / Playhome</span>
